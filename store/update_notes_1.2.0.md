...
“Auto target · same brightness & saturation”은 적록 색각 시뮬레이션에서 구분하기 쉬운 파랑·청록·보라 계열의 대체색을 추천합니다. OKLCH 색 공간을 사용해 원본 색상의 지각적 밝기와 채도를 유지합니다. 동일한 밝기와 채도의 색상이 sRGB 화면 범위를 벗어나면 밝기는 유지하고 채도만 표시 가능한 수준까지 최소한으로 낮춥니다.
...
- 현재 페이지 색상을 분석해 protan/deutan 시뮬레이션에서 혼동될 가능성이 있는 적록 색상 쌍을 찾습니다.
